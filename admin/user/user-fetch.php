...
$colonne = array("photo","email", "prenom","nom", "role", "status");
...
foreach($result as $row)
{
	...
	$sub_array[] = $row['nom'];
    $sub_array[] = '<strong class="badge badge-primary">' . get_role($row['role_id'])["label"] . '</strong>';
	$sub_array[] = $status;
	...
	<div class="btn-group">
      ...
      <div class="dropdown-menu">
        ...
        <a class="dropdown-item update" id="'.$row["id"].'" href="user-edit.php?id='.$row["id"].'"> Modifier </a>
